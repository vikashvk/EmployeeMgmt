...
public class MainController {
	...
	public Employee createEmployee1(@RequestBody Employee employee) {
		...
		Employee details = restTemplate.postForObject(uri, employee, Employee.class);
		return details;
	...
	public List<Employee> readEmployee() {
		final String uri = "http://localhost:9000/employee/getAll";
		RestTemplate restTemplate = new RestTemplate();
	...
	public Employee readData(@PathVariable String employeeId) {
		final String uri = "http://localhost:9000/employee/get/{employeeId}";
		RestTemplate restTemplate = new RestTemplate();
	...
	public Employee updateData(@PathVariable String employeeId, @RequestBody Employee employee) {
		final String uri = "http://localhost:9000/employee/update";
		RestTemplate restTemplate = new RestTemplate();
	...
	public ExpenseDetails createExpense(@RequestBody ExpenseDetails expenseDetails) {
		final String uri = "http://localhost:8102/expense/addExpense";
		RestTemplate restTemplate = new RestTemplate();
		ExpenseDetails details = restTemplate.postForObject(uri, expenseDetails, ExpenseDetails.class);
		return details;
	}

	@RequestMapping(value = "/readExpense", method = RequestMethod.GET)
	public List<ExpenseDetails> readExpense() {
		final String uri = "http://localhost:8102/expense/getAll";
		RestTemplate restTemplate = new RestTemplate();
	...
	public ExpenseDetails readByExpenseCode(@PathVariable int expenseCode) {
		final String uri = "http://localhost:8102/expense/getExpense/{expenseCode}";
		RestTemplate restTemplate = new RestTemplate();
	...
	public ExpenseDetails modifyExpense(@PathVariable int expenseCode,
		...
		final String uri = "http://localhost:8102/expense/modify";
		RestTemplate restTemplate = new RestTemplate();
	...
	public String deleteExpense(@PathVariable int expenseCode) {
		final String uri = "http://localhost:8102/expense/delete/{expenseCode}";
		RestTemplate restTemplate = new RestTemplate();
	...
	public Project createProject(@RequestBody Project project) {
		final String uri = "http://localhost:8082/project/add";
		RestTemplate restTemplate = new RestTemplate();
		Project details = restTemplate.postForObject(uri, project, Project.class);
		return details;
	}

	@RequestMapping(value = "/readAllProject", method = RequestMethod.GET)
	public List<Project> readAllProject() {
		final String uri = "http://localhost:8082/project/readAll";
		RestTemplate restTemplate = new RestTemplate();
		@SuppressWarnings("unchecked")
	...
	public Project readProjectById(@PathVariable int id) {
		final String uri = "http://localhost:8082/project/read/{id}";
		RestTemplate restTemplate = new RestTemplate();
...
//		ResponseEntity<ExpenseDetails> responseEntity = restTemplate.exchange(uri, HttpMethod.POST, requestEntity,
...
//		ResponseEntity<ExpenseDetails> responseEntity = restTemplate.exchange(uri, HttpMethod.PUT, requestEntity,
...
//		ExpenseDetails response = restTemplate.exchange("http://ECM/read/{expenseCode}", HttpMethod.GET, requestEntity,
...
//		ResponseEntity<List<ExpenseDetails>> list = restTemplate.exchange(uri, HttpMethod.GET, requestEntity,
...
//		requestHeaders.add("Accept", MediaType.APPLICATION_JSON_VALUE);
//		HttpEntity<ExpenseDetails> requestEntity = new HttpEntity<>(requestHeaders);
//		restTemplate.exchange("http://ECM/delete/{expenseCode}", HttpMethod.DELETE, requestEntity,
//				new ParameterizedTypeReference<String>() {
//				}, expenseCode).getBody();
//		return "Deleted";
//	}
//	
//	  @RequestMapping(value = "/deleteExpense/{expenseCode}", method =
//	  RequestMethod.DELETE) public String deleteExpense(@PathVariable int expenseCode) { final String uri =
//	  "http://localhost:8102/ecm/delete/{expenseCode}"; RestTemplate restTemplate =
//	  new RestTemplate(); restTemplate.delete(uri, expenseCode); return
//	  "Delete Success";	
//	@RequestMapping(value = "/createEmployee", method = RequestMethod.POST)
//	@ResponseBody
...
//		ResponseEntity<Employee> responseEntity = restTemplate.exchange(uri, HttpMethod.POST, requestEntity,
//				Employee.class);
//		return responseEntity;
//	}
//
...
//		ResponseEntity<List<Employee>> list = restTemplate.exchange(uri, HttpMethod.GET, requestEntity,
//				new ParameterizedTypeReference<List<Employee>>() {
//				});
//		return list;
//	}
//	@RequestMapping(value = "/modifyEmployee/{employeeId}", method = RequestMethod.PUT)
//	public ResponseEntity<Employee> modifyExpense(@PathVariable String employeeId, @RequestBody Employee employee) {
//		final String uri = "http://Employee/modify/{employeeId}";
//		HttpHeaders requestHeaders = new HttpHeaders();
//		requestHeaders.setContentType(MediaType.APPLICATION_JSON);
//		requestHeaders.setAccept(Arrays.asList(MediaType.APPLICATION_JSON));
//		HttpEntity<Employee> requestEntity = new HttpEntity<>(employee, requestHeaders);
//		ResponseEntity<Employee> responseEntity = restTemplate.exchange(uri, HttpMethod.PUT, requestEntity,
...
//		restTemplate.exchange("http://Employee/delete/{employeeId}", HttpMethod.DELETE, requestEntity,
//				new ParameterizedTypeReference<String>() {
//				}, employeeId).getBody();
//		return "Deleted";
//	}
...
//		requestHeaders.add("Accept", MediaType.APPLICATION_JSON_VALUE);
//		HttpEntity<Employee> requestEntity = new HttpEntity<>(requestHeaders);
//		Employee response = restTemplate.exchange("http://Employee/read/{employeeId}", HttpMethod.GET, requestEntity,
